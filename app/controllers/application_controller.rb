...
class ApplicationController < ActionController::Base
  ...
  WEBLAYOUT = SiteSettings::SITE_LAYOUT

  before_filter :get_company_name, :set_dynamic_module_name

  def set_dynamic_module_name
    @dm_one = SiteSettings::DYNAMIC_MODULES['one']
  end

  def get_company_name
    @company_name_for_layout = SiteProfile.first.company_name
  end
